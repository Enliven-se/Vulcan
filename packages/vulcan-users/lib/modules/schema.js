...
// ///////////////////////////////////// Order for the Schema is as follows.
// Change as you see fit: 00.
// 10. Display Name
// 20. Email
// 30. Bio
// 40. Slug
// 50. Website
// 60. Twitter username 70. 80. 90. 100. Anything else..
// /////////////////////////////////////
...
const schema = {
  ...
  // // telescope-specific data, kept for backward compatibility and migration
  // purposes telescope: {   type: Object,   blackbox: true,   optional: true, },
  services: {
    type: Object,
    optional: true,
    blackbox: true,
  ...
  */
  email: {
    ...
    searchable: true,
    // unique: true // note: find a way to fix duplicate accounts before enabling
    // this
  },
  /**
  ...
  */
  slug: {
    ...
    order: 40,
    onCreate: ({document: user}) => {
      // create a basic slug from display name and then modify it if this slugs
      // already exists;
